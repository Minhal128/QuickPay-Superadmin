...
const CampaignTopStats = () => {
  const { data } = useApi<{ stats: Stat[] }>("/campaigns/stats");
  const statsData = data?.stats ?? [];

  return (
    <div className="w-full">
      <div className="grid grid-cols-1 sm:grid-cols-2 p-4 bg-[#121212] xl:grid-cols-3 gap-3">
...
export default CampaignTopStats;
